...
namespace HouseRentMVCML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\320090153\Pictures\House.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Locality: {sampleData.Locality}");
            Console.WriteLine($"Area: {sampleData.Area}");
            Console.WriteLine($"Bedrooms: {sampleData.Bedrooms}");
            Console.WriteLine($"Furnishing: {sampleData.Furnishing}");
